...
class MobileExportTests(unittest.TestCase):
    ...
    def test_mobile_shell_revision_is_bumped_with_lane_schema(self):
        ...
        self.assertIn("app.js?v=20260812-v23", html)
        self.assertIn("styles.css?v=20260812-v23", html)
        self.assertIn('register("./sw.js?v=20260812-v23")', javascript)
        self.assertIn('const CACHE_NAME = "cg-signal-mobile-v23"', worker)
        self.assertIn("app.js?v=20260812-v23", worker)
    ...
    def test_mobile_shell_has_a_recent_publication_window(self):
        ...
        self.assertIn("cg-signal-mobile-v23", service_worker)
        self.assertIn("styles.css?v=20260812-v23", service_worker)
        self.assertIn("app.js?v=20260812-v23", service_worker)
        self.assertIn("./domain.mjs", service_worker)
        self.assertIn("sw.js?v=20260812-v23", javascript)
        self.assertIn("sw.js?v=20260812-v23", service_worker)
